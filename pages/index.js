  ...
  return (
    <>
      ...
      <div className="container-fluid p-5 bg-dark">
        ...
        <div class="btn-group d-flex justify-content-center align-items-center px-4">
          <a href="#" class="btn btn-light m-2">Day 1</a>
          <a href="#" class="btn btn-light m-2">Day 2</a>
          <a href="#" class="btn btn-light m-2">Day 3</a>
        </div>
      </div>
